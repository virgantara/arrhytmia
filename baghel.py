...
file_to_label = {"dataset/YaseenDeepLearning/audio_train/"+k:v for k,v in zip(train_labels.fname.values, train_labels.label.values)}
list_labels = sorted(list(set(train_labels.label.values)))

test_file_to_label = {"dataset/YaseenDeepLearning/audio_test/"+k:v for k,v in zip(test_labels.fname.values, test_labels.label.values)}
